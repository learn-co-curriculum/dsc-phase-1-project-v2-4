...
We found that Adventure, Sci-Fi, Animation, Action, Comedy, and Drama (in that order) were relatively high-performing on most or all metrics. Biography films were intersting in that they had very high ratings, although they performed poorly financially. Films with multiple genres also performed better on both financial measures.
...
* hy_exploration files are Han's notebooks.
